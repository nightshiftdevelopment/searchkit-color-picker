...
export {colorNames};
//adopted from: http://chir.ag/projects/ntc/ntc.js
//Name that Color JavaScript by Chirag Mehta
...
export class ColorMapper {
  constructor() {
    ...
    for(var i = 0; i < colorNames.length; i++) {
      ...
      rgb = this.convertrgb(color);
      hsl = this.converthsl(color);
  ...
  name(color) {
    ...
    var rgb = this.convertrgb(color);
    var r = rgb[0], g = rgb[1], b = rgb[2];
    var hsl = this.converthsl(color);
   ...
   return (cl < 0 ? {hex:"#000000", name:"Invalid Color: " + color, exact:false} : {hex:"#" + colorNames[cl][0], name: colorNames[cl][1], exact: false});
  }
